...

{
  ...
  local _service(name,
    ...
    spec: {
      ...
      ports: ports,
      selector: selector,
      [if externalTrafficPolicy != null then 'externalTrafficPolicy']: externalTrafficPolicy,
    },
  },
  service:: _service,

  local _service_external_name(name,
                               externalName,
                               ports,
                               labels={},
                               annotations={},
  ...
  service_external_name:: _service_external_name,
  ...
  sa(name, namespace=null, annotations={}, irsa_arn=null, wave=null):: {
    ...
    metadata: {
      annotations: annotations + (if wave != null then {
        'argocd.argoproj.io/sync-wave': std.toString(wave),
      } else {}) + if irsa_arn==null then {} else{
  ...
  roleBinding(name, role, sa, namespace=null, wave=null):: {
    kind: 'RoleBinding',
    apiVersion: 'rbac.authorization.k8s.io/v1',
    metadata: {
      name: name,
  ...
  local _clusterRoleBindingGroup = function(name, role, group, wave=null) {
    apiVersion: 'rbac.authorization.k8s.io/v1',
    kind: 'ClusterRoleBinding',
    metadata: {
      name: name,
  ...
  clusterRoleBindingGroup:: _clusterRoleBindingGroup,

  storageClassEBS(name, reclaimPolicy='Retain', wave=null):: {
  ...
  storageClassEFS(name, wave=null):: {
    apiVersion: 'storage.k8s.io/v1',
    kind: 'StorageClass',
    metadata: {
      name: name,
  ...
  persistentVolumeEFS(name, volumeHandle, wave=null):: {
    apiVersion: 'v1',
  ...
  pvClaim(name, storageClassName, storage, accessModes='ReadWriteOnce', wave=null):: {
    apiVersion: 'v1',
  ...
  pvClaimEFS(name, storage, accessModes='ReadWriteOnce', wave=null):: {
    apiVersion: 'v1',
    kind: 'PersistentVolumeClaim',
    metadata: {
      name: name,
  ...
  local _pdb = function(name, selector, minAvailable=1) {
