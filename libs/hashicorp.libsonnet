...

{
  ...
  local _workspace = function(name, source, vars=[], region=argo.config.region, outputs=[], sshKeyID='tf_modules', wave=null, branch='main') {
    ...
    spec: {
      ...
      module: {
        source: argo.config.env.terraform.src_prefix + '/' + source + '.git?ref=' + branch,
      },
      outputs: outputs,
      variables: vars + [
        /*
